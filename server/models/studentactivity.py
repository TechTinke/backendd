...
class StudentActivity(db.Model):
    ...
    amount_paid = db.Column(db.Float, nullable=False, default=0.0)  # Amount paid for the activity
    payment_status = db.Column(db.String(50), nullable=False, default='pending')  # Status of payment (e.g., 'paid', 'unpaid', 'partial')
    ...
    )# ensures a student is linked to only an activity once
